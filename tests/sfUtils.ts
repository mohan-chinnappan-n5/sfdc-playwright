...
export class Utils {
   ...
   */
  static sfLogin = async (
    orgName: string,
    page: string
  ): Promise<{ instanceUrl: string; [key: string]: any }> => {
  ...
  static createSFDXProjectCmd = (projectName) => {
  ...
  static retrieveCustomFieldCmd = (object, field, orgName) => {
